...
% ---------------- observations below
\node[tag, anchor=west] at (1.70, 1.62) {the lactate, measured four times};
...
\node[hot, anchor=west] at ({\X{980}}, 3.55) {thicker where the weight is larger};

% a second, fainter fan
\foreach \m/\w in {15/0.3, 380/0.5, 1120/1.5, 2650/1.1}{
    \draw[c2!30, line width=\w pt] ({\X{1980}}, 4.46) -- ({\X{\m}}, 2.19);
}
